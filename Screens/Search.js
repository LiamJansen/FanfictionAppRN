        ...
        return (
            <View style={styles.container}>
                ...
                <Text style={[styles.browseItem, styles.browseBotBorder]}
                    onPress={() => this.props.navigation.navigate("SearchAuthors")}
                >Search stories
                </Text>
                <Text style={[styles.browseItem, styles.browseBotBorder]}
                    onPress={() => this.props.navigation.navigate("SearchCommunities")}
                >Search authors</Text>
                <Text style={[styles.browseItem, styles.browseBotBorder]}
                    onPress={() => this.props.navigation.navigate("SearchStories")}
